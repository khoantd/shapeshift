...
import { UNIT_LABELS } from "@shapeshift/core/parse/convert";
import { tipAmounts } from "@shapeshift/core/parse/tip";
import { formatClock } from "@shapeshift/core/parse/timer";
import { describeRandom } from "@shapeshift/core/parse/random";
import { formatIn } from "@shapeshift/core/parse/timezone";
import { PRIORITY_LABEL } from "@shapeshift/core/parse/priority";
...
export const registry: Registry = {
  ...
  news: {
    label: "News",
    example: "critical news on AI regulation",
    icon: Newspaper,
    signals: ["urgency"],
    badges: urgent,
    edge: (s) => (s.urgent ? "var(--caution)" : null),
